...
# Run the Python script with arguments: nexps, nsamples, pos_res, neg_res, fit(bool), beneficial(bool) [times]
python plot_dfe.py 1 1 0.0002 0.0002 40 --no-fit --no-beneficial 0 10000 20000 30000 40000 49990 >> out_graph.txt 2>> err_graph.txt
