...
# Run the Python script with arguments: nexps, nsamples, dir_name, fit(bool), [times]
python plot_dfe.py 1 1 40 "lenski_data" --no-fit 0 10000 20000 30000 40000 49990 >> out_graph.txt 2>> err_graph.txt
