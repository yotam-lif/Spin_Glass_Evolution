...
# Run the Python script with arguments nexps, nsamples, nbins, border, [times]
python plot_dfe_tracker.py 2 1 18 0.0045 100 300 500 900 >> out_dfe_track.txt 2>> err_dfe_track.txt
